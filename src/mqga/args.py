...
parser.add_argument('-t', '--token', type=str, help='机器人密钥, 在 https://q.qq.com/bot/#/developer/developer-setting 获取')
parser.add_argument('-s', '--secret', type=str, help='机器人令牌, 在 https://q.qq.com/bot/#/developer/developer-setting 获取')
